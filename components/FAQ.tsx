...
const FAQ = () => {
  ...
  const handleCategoryClick = (category: string) => {
    ...
    // Open first FAQ of selected category
    const filtered = getFilteredFAQs(category);
    if (filtered.length > 0) {
      setOpenFAQ(filtered[0].id);
    } else {
      setOpenFAQ(null);
    }
  };
  ...
  // Show first 8 FAQs on homepage for better preview
    ...
    >
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="text-center mt-8 md:mt-12">
          <Link href="/faq">
            <Button className="bg-gradient-primary text-white hover:opacity-90 font-semibold px-6 md:px-8 py-6 md:py-7 flex items-center gap-2 mx-auto">
              View All FAQs
