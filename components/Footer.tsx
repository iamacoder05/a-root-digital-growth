...
const Footer = () => {
  return (
    <footer role="contentinfo" aria-label="Footer" className="bg-primary text-white py-12 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://facebook.com/arootdigital" aria-label="Visit our Facebook page" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-accent/20 rounded-full flex items-center justify-center hover:bg-primary-accent/30 transition-colors">
                <Facebook className="w-5 h-5 text-primary-accent" />
              </a>
              <a href="https://instagram.com/arootdigital" aria-label="Visit our Instagram profile" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-accent/20 rounded-full flex items-center justify-center hover:bg-primary-accent/30 transition-colors">
                <Instagram className="w-5 h-5 text-primary-accent" />
              </a>
              <a href="https://linkedin.com/company/arootdigital" aria-label="Visit our LinkedIn company page" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-accent/20 rounded-full flex items-center justify-center hover:bg-primary-accent/30 transition-colors">
                <Linkedin className="w-5 h-5 text-primary-accent" />
              </a>
              <a href="https://twitter.com/arootdigital" aria-label="Visit our Twitter profile" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-primary-accent/20 rounded-full flex items-center justify-center hover:bg-primary-accent/30 transition-colors">
