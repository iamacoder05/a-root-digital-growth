...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[#25D366]/50 rounded-full animate-ping opacity-75" />
      <div className="absolute inset-0 bg-gradient-to-br from-[#25D366]/90 via-[#20BA5A]/90 to-[#128C7E]/90 rounded-full" />
      
      {/* WhatsApp Icon */}
      <svg
        className="w-6 h-6 relative z-10 transition-transform duration-300 group-hover:scale-110 text-white drop-shadow-lg"
        fill="currentColor"
        viewBox="0 0 24 24"
