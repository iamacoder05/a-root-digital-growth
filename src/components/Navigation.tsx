    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          >
            <img src={logo} alt="A Root Digital" className="w-12 h-12 object-contain" />
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-20 left-0 right-0 bg-background/98 backdrop-blur-lg shadow-lg border-t border-border animate-fade-in">
